...
func ExampleNewMnemonic() {
	...
	// generate a mnemomic
	mnemomic, _ := NewMnemonic(entropy)
...
func ExampleNewSeed() {
	seed := NewSeed("all hour make first leader extend hole alien behind guard gospel lava path output census museum junior mass reopen famous sing advance salt reform", "TREZOR")
